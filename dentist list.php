          ...
          <ul>
            ...
            <li class="relative px-6 py-3">
              <a
                ...
                href="buttons.html"
              >
              <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.47 122.88"aria-hidden="true"
              fill="none"
              width="16"
               height="16"
              stroke-linecap="round"
              ...
              <template x-if="isPagesMenuOpen">
                ...
                >
                  ...
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full" href="pages/add-user.html">
                      Create account
                    </a>
                  </li>
                  <li
